...
outfile1 <- args[2]
# infile1  <- '/tmp//chr_pos_pheno_pvalue.tab'
...
getReadyForPlot <- function(data1, Gender, Pheno, logBase) {
...
plot_Manhattan_allCohorts <- function(data1, Gender, Pheno, logBase, verysignifline, genomewideline, suggestiveline) {
    data <- getReadyForPlot(data1, Gender, Pheno, logBase)
