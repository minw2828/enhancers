...
# outfile1 <- '/group/dairy/Min/geno2pheno/analyses/2016-01-19/a/out/GSEA/permutation.NbSigSnpPerPhenoDb/NbSigSnp.10e-08.10000.6.2016-01-19.a.csv'
...
run <- function() {
    ...
    data2 <- read_file(infile2) # promoter variants
