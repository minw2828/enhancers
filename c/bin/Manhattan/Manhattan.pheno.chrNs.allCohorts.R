...
getReadyForPlot <- function(data1, Pheno, logBase, chrs) {
...
plot_Manhattan_allCohorts <- function(data1, Pheno, logBase, chrs, verysignifline, genomewideline, suggestiveline) {
    data <- getReadyForPlot(data1, Pheno, logBase, chrs)
    Title <- Pheno
...
draw_plots <- function(data1, loopList, logBase, chrs, verysignifline, genomewideline, suggestiveline, nc, subPlotIndex, outfile) {
    ...
    for (i in seq(3, nr)) {
        index <- i - 2
        g <- plot_Manhattan_allCohorts(data1, loopList[index]$pheno, logBase, chrs, verysignifline, genomewideline, suggestiveline)
